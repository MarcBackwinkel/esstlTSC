let calcTaxAndSum,calculateTax,printDetails,applyDiscount;_e5c‍.w("./tax",[["default",["calcTaxAndSum"],function(v){calcTaxAndSum=v}],["calculateTax",["calculateTax"],function(v){calculateTax=v}]]);_e5c‍.w("./utils",[["printDetails",["printDetails"],function(v){printDetails=v}],["applyDiscount",["applyDiscount"],function(v){applyDiscount=v}]]);
...
Object.keys(data).forEach(key => _e5c‍.g.console.log(data[key].toString()));
//Object.value(object) returns an array containing the property values defined by the object
Object.values(data).forEach(value => _e5c‍.g.console.log(value.toString()));
...
[...dataMap.keys()].forEach(key => _e5c‍.g.console.log(dataMap.get(key).toString()));
