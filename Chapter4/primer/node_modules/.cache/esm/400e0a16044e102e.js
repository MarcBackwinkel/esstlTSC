let calcTax;_044‍.w("./tax",[["default",["calcTax"],function(v){calcTax=v}]]);
...
Object.keys(data).forEach(key => _044‍.g.console.log(data[key].toString()));
//Object.value(object) returns an array containing the property values defined by the object
Object.values(data).forEach(value => _044‍.g.console.log(value.toString()));
...
[...dataMap.keys()].forEach(key => _044‍.g.console.log(dataMap.get(key).toString()));
